...
7. **버전 1.0** — 스크린샷 6.9″ 슬롯에 `iphone69/ko` 7장(`01_home`…`07_settings`, 순서 그대로), 6.5″ 슬롯에 `iphone65/ko` 7장. en-US 현지화 추가 후 `iphone69/en`. 프로모션 텍스트·설명·키워드·지원 URL·마케팅 URL은 문안 파일에서 복사. 저작권 `2026 LightOn Plus Lab`.
